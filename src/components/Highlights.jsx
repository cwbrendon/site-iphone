            ...
            <div className="max-w-7xl mx-auto">
                ...
                <div className="grid grid-cols-2 gap-8 mb-16">
                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full rounded-2xl mb-4" src="/iphone17/img/tres-cores.jpg" alt="3 iphones de cores diferentes"></img>
                        <h3 className="font-bold mb-2 text-3xl">Titânio Premium</h3>
                        <p className="tex-gray-300">Estrutura em titânio de grau aeroespacial. O smartphone mais forte e leve.</p>
                    </div>

                    <div className="bg-gray-900 rounded-3xl p-8">
                        <img className="w-full h-5/6 rounded-2xl mb-4" src="/iphone17/img/highlights.jpg" alt="iOS 2026"></img>
                        <h3 className="font-bold mb-2 text-3xl">iOS 26</h3>
                        <p className="tex-gray-300">O sistema operacional mais avançado do mundo com IA integrada.</p>
                    </div>
                </div>

                <div className="bg-gray-900 rounded-3xl p-12 mb-16" id="performance">
                    <h3 className="text-4xl font-bold mb-6 text-gradient">A19 Pro</h3>
                    <p className="tex-gray-300 mb-6">O chip mais poderoso em um smartphone</p>
                    <img className="w-full rounded-2xl mb-4" src="/iphone17/img/laranja.jpg" alt="iPhone 17 pro laranja"></img>
